...
export class Game {
  ...
  initializeScene() {
    ...
    // Rotate the entire city to match isometric view
    this.city.rotation.x = -Math.PI / 2;
    
    // Add to DOM
    document.getElementById('render-target').appendChild(this.renderer.domElement);
  }
}
